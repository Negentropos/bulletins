...
def creerBulletinAppreciations(appreciation,competences,canvas,dictParamBulletins,story,bulletinUtilisationCompetence,num):
    ...
    largeur_competence = largeur_evaluation*14/15
    largeur_evaluation_competence=largeur_evaluation*1/15
    ...
    if bulletinUtilisationCompetence == True:
        for competence in competences.all():
            if competence.evaluation != '-':
                ...
                competenceEvaluation,styleCompetenceEvaluation=pdf_donnees.competenceEvaluation(competence.evaluation,taillePoliceEvaluation,font)
